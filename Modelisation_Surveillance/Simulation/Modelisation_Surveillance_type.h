#ifndef MODELISATION_SURVEILLANCE_TYPES_CONVERSION
#define MODELISATION_SURVEILLANCE_TYPES_CONVERSION
 ...
 ** array_float64_3_1 
 ****************************************************************/
extern int array_float64_3_1_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_array_float64_3_1_string(const char *str, char **endptr);
extern int string_to_array_float64_3_1(const char *str, void *pValue, char **endptr);
extern int is_array_float64_3_1_double_conversion_allowed();
extern int array_float64_3_1_to_double(const void *pValue, double *nValue);
extern int is_array_float64_3_1_long_conversion_allowed();
extern int array_float64_3_1_to_long(const void *pValue, long *nValue);
extern void compare_array_float64_3_1(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_array_float64_3_1_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int init_array_float64_3_1(void *pValue);
extern int release_array_float64_3_1(void *pValue);
extern int copy_array_float64_3_1(void *pToValue, const void *pFromValue);
extern SimTypeUtils _Type_array_float64_3_1_Utils;
...
#endif /*MODELISATION_SURVEILLANCE_TYPES_CONVERSION */
