...
const MappingEntry scope_59_entries[38] = {
    ...
    /* 16 */ { MAP_LOCAL, "_L18", NULL, sizeof(kcg_float64), (size_t)&outputs_ctx._L18_Calculate_SM1, &_Type_kcg_float64_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 16 },
    /* 17 */ { MAP_LOCAL, "_L19", NULL, sizeof(kcg_float64), (size_t)&outputs_ctx._L19_Calculate_SM1, &_Type_kcg_float64_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 17 },
    /* 18 */ { MAP_LOCAL, "_L20", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L20_Calculate_SM1, &_Type_kcg_bool_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 18 },
    /* 19 */ { MAP_LOCAL, "_L21", NULL, sizeof(kcg_float64), (size_t)&outputs_ctx._L21_Calculate_SM1, &_Type_kcg_float64_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 19 },
    /* 20 */ { MAP_LOCAL, "_L22", NULL, sizeof(kcg_float64), (size_t)&outputs_ctx._L22_Calculate_SM1, &_Type_kcg_float64_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 20 },
    /* 21 */ { MAP_LOCAL, "_L23", NULL, sizeof(kcg_float64), (size_t)&outputs_ctx._L23_Calculate_SM1, &_Type_kcg_float64_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 21 },
    /* 22 */ { MAP_LOCAL, "_L24", NULL, sizeof(kcg_float64), (size_t)&outputs_ctx._L24_Calculate_SM1, &_Type_kcg_float64_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 22 },
    /* 23 */ { MAP_LOCAL, "_L25", NULL, sizeof(kcg_float64), (size_t)&outputs_ctx._L25_Calculate_SM1, &_Type_kcg_float64_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 23 },
    /* 24 */ { MAP_LOCAL, "_L26", NULL, sizeof(kcg_float64), (size_t)&outputs_ctx._L26_Calculate_SM1, &_Type_kcg_float64_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 24 },
    /* 25 */ { MAP_LOCAL, "_L27", NULL, sizeof(kcg_float64), (size_t)&outputs_ctx._L27_Calculate_SM1, &_Type_kcg_float64_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 25 },
    /* 26 */ { MAP_LOCAL, "_L28", NULL, sizeof(kcg_float64), (size_t)&outputs_ctx._L28_Calculate_SM1, &_Type_kcg_float64_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 26 },
    /* 27 */ { MAP_LOCAL, "_L42", NULL, sizeof(Ten_Values_Table), (size_t)&outputs_ctx._L42_Calculate_SM1, &_Type_Ten_Values_Table_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, &scope_5, 1, 27 },
    /* 28 */ { MAP_LOCAL, "_L43", NULL, sizeof(kcg_float64), (size_t)&outputs_ctx._L43_Calculate_SM1, &_Type_kcg_float64_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 28 },
    ...
    /* 30 */ { MAP_LOCAL, "_L29", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L29_Calculate_SM1, &_Type_kcg_bool_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 30 },
    /* 31 */ { MAP_LOCAL, "_L17", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L17_Calculate_SM1, &_Type_kcg_bool_Utils, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Calculate_SM1, NULL, 1, 31 },
...
const MappingEntry scope_13_entries[7] = {
    ...
    /* 1 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_bool), offsetof(outC_Check_interval_pH, _L2), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_float64), offsetof(outC_Check_interval_pH, _L4), &_Type_kcg_float64_Utils, NULL, NULL, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_float64), offsetof(outC_Check_interval_pH, _L5), &_Type_kcg_float64_Utils, NULL, NULL, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_float64), offsetof(outC_Check_interval_pH, _L6), &_Type_kcg_float64_Utils, NULL, NULL, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_bool), offsetof(outC_Check_interval_pH, _L8), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_bool), offsetof(outC_Check_interval_pH, _L9), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 6 }
};
...
const MappingEntry scope_12_entries[7] = {
    ...
    /* 2 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_bool), offsetof(outC_Check_interval_Temperature, _L4), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_float64), offsetof(outC_Check_interval_Temperature, _L5), &_Type_kcg_float64_Utils, NULL, NULL, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L7", NULL, sizeof(kcg_bool), offsetof(outC_Check_interval_Temperature, _L7), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_bool), offsetof(outC_Check_interval_Temperature, _L9), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_float64), offsetof(outC_Check_interval_Temperature, _L10), &_Type_kcg_float64_Utils, NULL, NULL, NULL, 1, 6 }
};
...
const MappingEntry scope_11_entries[7] = {
    ...
    /* 1 */ { MAP_LOCAL, "_L1", NULL, sizeof(kcg_bool), offsetof(outC_Check_interval_Redox, _L1), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_float64), offsetof(outC_Check_interval_Redox, _L4), &_Type_kcg_float64_Utils, NULL, NULL, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_float64), offsetof(outC_Check_interval_Redox, _L5), &_Type_kcg_float64_Utils, NULL, NULL, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_float64), offsetof(outC_Check_interval_Redox, _L6), &_Type_kcg_float64_Utils, NULL, NULL, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L7", NULL, sizeof(kcg_bool), offsetof(outC_Check_interval_Redox, _L7), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_bool), offsetof(outC_Check_interval_Redox, _L8), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 6 }
};
...
const MappingEntry scope_7_entries[15] = {
    ...
    /* 14 */ { MAP_INSTANCE, "Vote_Alog 1", NULL, sizeof(outC_Vote_Alog), (size_t)&outputs_ctx.Context_Vote_Alog_1, NULL, &scope_6_entries[0], isActive_SSM_ST_SM1_SSM_st_Normal_Station_SM1, &scope_10, 1, 14 }
};
