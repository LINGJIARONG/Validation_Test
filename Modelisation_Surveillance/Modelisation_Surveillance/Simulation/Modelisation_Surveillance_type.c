...
#ifdef __cplusplus
  #ifdef pSimarray_float64_1VTable_defined
    extern struct SimTypeVTable *pSimarray_float64_1VTable;
  #else 
    struct SimTypeVTable *pSimarray_float64_1VTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimarray_float64_1VTable;
#endif

int array_float64_1_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimarray_float64_1VTable != NULL
        && pSimarray_float64_1VTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimarray_float64_1VTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnArrayToString(pValue, kcg_float64_to_string, 1, sizeof(kcg_float64), pfnStrAppend, pStrObj);
}

int check_array_float64_1_string(const char *str, char **endptr)
{
    static array_float64_1 rTemp;
    return string_to_array_float64_1(str, &rTemp, endptr);
}

int string_to_array_float64_1(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimarray_float64_1VTable != NULL) {
        nRet = string_to_VTable(str, pSimarray_float64_1VTable, pValue, endptr);
    }
    if (nRet == 0) {
        nRet = pConverter->m_pfnStringToArray(str, pValue, &_Type_kcg_float64_Utils, 1, sizeof(kcg_float64), endptr);
    }
    return nRet;
}

int is_array_float64_1_double_conversion_allowed()
{
    if (pSimarray_float64_1VTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimarray_float64_1VTable);
    }
    return 0;
}

int array_float64_1_to_double(const void *pValue, double *nValue)
{
    if (pSimarray_float64_1VTable != NULL) {
        return VTable_to_double(pValue, pSimarray_float64_1VTable, nValue);
    }
    return 0;
}

int is_array_float64_1_long_conversion_allowed()
{
    if (pSimarray_float64_1VTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimarray_float64_1VTable);
    }
    return 0;
}

int array_float64_1_to_long(const void *pValue, long *nValue)
{
    if (pSimarray_float64_1VTable != NULL) {
        return VTable_to_long(pValue, pSimarray_float64_1VTable, nValue);
    }
    return 0;
}

void compare_array_float64_1(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimarray_float64_1VTable != NULL
        && pSimarray_float64_1VTable->m_version >= Scv612
        && pSimarray_float64_1VTable->m_pfnCompare != NULL) {
        if (pSimarray_float64_1VTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimarray_float64_1VTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimarray_float64_1VTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        pConverter->m_pfnArrayComparison(pResult, pValue1, pValue2, 
                compare_kcg_float64, 1, sizeof(kcg_float64), pTol, pszPath, pfnStrListAppend, pListErrPaths);
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_array_float64_1_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetArraySignature(get_kcg_float64_signature, 1, pfnStrAppend, pStrObj); 
}

int init_array_float64_1(void *pValue)
{
    size_t i;
    for (i = 0; i < 1; i++)
...
int release_array_float64_1(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_array_float64_1(void *pToValue, const void *pFromValue)
{
    kcg_copy_array_float64_1((array_float64_1*)pToValue, (array_float64_1*)pFromValue);
    return 1;
}

SimTypeUtils _Type_array_float64_1_Utils = {
    array_float64_1_to_string,
    check_array_float64_1_string,
    string_to_array_float64_1,
    is_array_float64_1_double_conversion_allowed,
    array_float64_1_to_double,
    is_array_float64_1_long_conversion_allowed,
    array_float64_1_to_long,
    compare_array_float64_1,
    get_array_float64_1_signature,
    init_array_float64_1,
    release_array_float64_1,
    copy_array_float64_1,
    sizeof(array_float64_1)
};
...
#ifdef __cplusplus
  #ifdef pSimarray_float64_3_1VTable_defined
    extern struct SimTypeVTable *pSimarray_float64_3_1VTable;
  #else 
    struct SimTypeVTable *pSimarray_float64_3_1VTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimarray_float64_3_1VTable;
#endif

int array_float64_3_1_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimarray_float64_3_1VTable != NULL
        && pSimarray_float64_3_1VTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimarray_float64_3_1VTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnArrayToString(pValue, Data_to_string, 1, sizeof(Data), pfnStrAppend, pStrObj);
}

int check_array_float64_3_1_string(const char *str, char **endptr)
{
    static array_float64_3_1 rTemp;
    return string_to_array_float64_3_1(str, &rTemp, endptr);
}

int string_to_array_float64_3_1(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimarray_float64_3_1VTable != NULL) {
        nRet = string_to_VTable(str, pSimarray_float64_3_1VTable, pValue, endptr);
    }
    if (nRet == 0) {
        nRet = pConverter->m_pfnStringToArray(str, pValue, &_Type_Data_Utils, 1, sizeof(Data), endptr);
    }
    return nRet;
}

int is_array_float64_3_1_double_conversion_allowed()
{
    if (pSimarray_float64_3_1VTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimarray_float64_3_1VTable);
    }
    return 0;
}

int array_float64_3_1_to_double(const void *pValue, double *nValue)
{
    if (pSimarray_float64_3_1VTable != NULL) {
        return VTable_to_double(pValue, pSimarray_float64_3_1VTable, nValue);
    }
    return 0;
}

int is_array_float64_3_1_long_conversion_allowed()
{
    if (pSimarray_float64_3_1VTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimarray_float64_3_1VTable);
    }
    return 0;
}

int array_float64_3_1_to_long(const void *pValue, long *nValue)
{
    if (pSimarray_float64_3_1VTable != NULL) {
        return VTable_to_long(pValue, pSimarray_float64_3_1VTable, nValue);
    }
    return 0;
}

void compare_array_float64_3_1(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimarray_float64_3_1VTable != NULL
        && pSimarray_float64_3_1VTable->m_version >= Scv612
        && pSimarray_float64_3_1VTable->m_pfnCompare != NULL) {
        if (pSimarray_float64_3_1VTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimarray_float64_3_1VTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimarray_float64_3_1VTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        pConverter->m_pfnArrayComparison(pResult, pValue1, pValue2, 
                compare_Data, 1, sizeof(Data), pTol, pszPath, pfnStrListAppend, pListErrPaths);
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_array_float64_3_1_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetArraySignature(get_Data_signature, 1, pfnStrAppend, pStrObj); 
}

int init_array_float64_3_1(void *pValue)
{
    size_t i;
    for (i = 0; i < 1; i++)
...
int release_array_float64_3_1(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_array_float64_3_1(void *pToValue, const void *pFromValue)
{
    kcg_copy_array_float64_3_1((array_float64_3_1*)pToValue, (array_float64_3_1*)pFromValue);
    return 1;
}

SimTypeUtils _Type_array_float64_3_1_Utils = {
    array_float64_3_1_to_string,
    check_array_float64_3_1_string,
    string_to_array_float64_3_1,
    is_array_float64_3_1_double_conversion_allowed,
    array_float64_3_1_to_double,
    is_array_float64_3_1_long_conversion_allowed,
    array_float64_3_1_to_long,
    compare_array_float64_3_1,
    get_array_float64_3_1_signature,
    init_array_float64_3_1,
    release_array_float64_3_1,
    copy_array_float64_3_1,
    sizeof(array_float64_3_1)
};
